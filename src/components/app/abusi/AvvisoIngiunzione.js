...
class AvvisoIngiunzione extends React.Component{
  ...
  downloadModulo(){
    window.open(LINKS.avvioingiunzione, '_blank')
  }
      ...
      if( this.state.data.length == 0 ){
        tableContents.push(
          ...
          for ( var i = 0; i < this.state.data.length; i++){
            tableContents.push(
              <TableRow key={i}>
                <TableRowColumn>Avvio Ingiunzione {i+1}</TableRowColumn>
      ...
      return (
          <Box column style={{marginTop:'30px', width:'98%'}} alignItems="flex-start" justifyContent="flex-start">
              <Toolbar style={{backgroundColor:'#4CA7D0', width:'100%'}}>
                <ToolbarTitle text="File caricato per Avvio Ingiunzione" style={{color:'#FFFFFF', textAlign:'center', fontSize:'15px'}}/>
