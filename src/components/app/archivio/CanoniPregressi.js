        ...
        <Box column justifyContent="center" alignItems="center" style={{height:'100%', width:'100%'}}>
          <Paper zDepth={1} style={styles.paper}>
            ...
            <Box column justifyContent="center" alignItems="center" style={{marginTop:'30px', marginBottom:'30px'}}>
              ...
              <RaisedButton label="Calcola Tassa Regionale" primary={true} labelStyle={{color:'#FFFFFF'}} style={{marginTop:'20px'}} onTouchTap={this.downloadCanoniRegionali.bind(this)}/>
            </Box>
          </Paper>
        </Box>
      </MuiThemeProvider>
