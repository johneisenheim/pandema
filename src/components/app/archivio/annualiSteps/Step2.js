...
import RicevutaCanone from './RicevutaCanone';
import RicevuteSpese from './RicevuteSpese';
import AttestatoCauzione from './AttestatoCauzione';
  ...
  render (){
      return (
          <div style={{marginLeft:'20px', width : '100%', marginRight:'20px'}}>
            <RicevutaCanone pid={this.props.pid} dbid={this.props.dbid} path={this.props.path}/>
            <RicevuteSpese pid={this.props.pid} dbid={this.props.dbid} path={this.props.path}/>
            <AttestatoCauzione pid={this.props.pid} dbid={this.props.dbid} path={this.props.path}/>
          </div>
      );
    }
