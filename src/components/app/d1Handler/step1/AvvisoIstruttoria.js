...
class AvvisoIstruttoria extends React.Component{
  ...
  downloadModulo(){
    window.open(LINKS.avvioistruttoriad1, '_blank')
  }
              ...
              <Toolbar style={{backgroundColor:'#4CA7D0', width:'100%'}}>
                ...
                <ToolbarGroup style={{marginRight:'0px'}}>
                  ...
                  <FlatButton label="Allega File" icon={<Attach style={{fill:'#FFFFFF'}}/>} style={{marginTop:'10px', marginRight:'0px'}} labelStyle={{color:'#FFFFFF'}} disabled={this.state.data.length > 0}>
                    {this.state.data.length == 0 ? <input type="file" style={styles.inputFile} accept="application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" onChange={this._avvisoPubblicazioneFileHandler.bind(this)} ref="file"/> : null}
                  </FlatButton>
                </ToolbarGroup>
              </Toolbar>
