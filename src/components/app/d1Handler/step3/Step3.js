...
class Step3 extends React.Component{
  ...
  state = {
    a : greatObject.d1.files !== undefined ? (greatObject.d1.files['agenziadogana'] !== undefined ? 'Caricato' : 'Non caricato') : 'Non caricato',
    b : greatObject.d1.files !== undefined ? (greatObject.d1.files['agenziademanio'] !== undefined ? 'Caricato' : 'Non caricato') : 'Non caricato',
    c : greatObject.d1.files !== undefined ? (greatObject.d1.files['pareretecnico'] !== undefined ? 'Caricato' : 'Non caricato') : 'Non caricato',
    d : greatObject.d1.files !== undefined ? (greatObject.d1.files['parereurbanistico'] !== undefined ? 'Caricato' : 'Non caricato') : 'Non caricato',
    e : greatObject.d1.files !== undefined ? (greatObject.d1.files['pareresopraintendenza'] !== undefined ? 'Caricato' : 'Non caricato') : 'Non caricato',
    f : greatObject.d1.files !== undefined ? (greatObject.d1.files['pareresic'] !== undefined ? 'Caricato' : 'Non caricato') : 'Non caricato',
    g : greatObject.d1.files !== undefined ? (greatObject.d1.files['parereautoritamarittima'] !== undefined ? 'Caricato' : 'Non caricato') : 'Non caricato',
    h : greatObject.d1.files !== undefined ? (greatObject.d1.files['pareresopraintendenzaarcheologica'] !== undefined ? 'Caricato' : 'Non caricato') : 'Non caricato',
    i : greatObject.d1.files !== undefined ? (greatObject.d1.files['parereautoritabacino'] !== undefined ? 'Caricato' : 'Non caricato') : 'Non caricato',
    l : 'Non caricato',
    currentTitle : '',
    currentLetter : '',
    checkColor : '#D6D6D6',
  ...
  _onFileInputChange(e){
    ...
    switch(e){
      case 'agenziadogana':
        greatObject.d1['files']['agenziadogana'] = this.refs.file1.files[0];
        this.setState({
          ...this.state,
          a : 'Caricato'
        });
      break;
      case 'agenziademanio':
        greatObject.d1['files']['agenziademanio'] = this.refs.file2.files[0];
        this.setState({
          ...this.state,
          b : 'Caricato'
        });
      break;
      case 'pareretecnico':
        greatObject.d1['files']['pareretecnico'] = this.refs.file3.files[0];
        this.setState({
          ...this.state,
          c : 'Caricato'
        });
      ...
      case 'parereurbanistico':
        greatObject.d1['files']['parereurbanistico'] = this.refs.file4.files[0];
        this.setState({
          ...this.state,
          d : 'Caricato'
        });
      ...
      case 'pareresopraintendenza':
        greatObject.d1['files']['pareresopraintendenza'] = this.refs.file5.files[0];
        this.setState({
          ...this.state,
          e : 'Caricato'
        });
      break;
      case 'pareresic':
        greatObject.d1['files']['pareresic'] = this.refs.file6.files[0];
        this.setState({
          ...this.state,
          f : 'Caricato'
        });
      ...
      case 'parereautoritamarittima':
        greatObject.d1['files']['parereautoritamarittima'] = this.refs.file7.files[0];
        this.setState({
          ...this.state,
          g : 'Caricato'
        });
      ...
      case 'pareresopraintendenzaarcheologica':
        greatObject.d1['files']['pareresopraintendenzaarcheologica'] = this.refs.file8.files[0];
        this.setState({
          ...this.state,
          h : 'Caricato'
        });
      ...
      case 'parereautoritabacino':
        greatObject.d1['files']['parereautoritabacino'] = this.refs.file9.files[0];
        this.setState({
          ...this.state,
          i : 'Caricato'
        });
  ...
  onDisallega(letter, who){
    switch(letter){
      case 'a':
        ...
        greatObject.d1['files']['agenziadogana'] = undefined;
      break;
      case 'b':
        this.setState({
          b : 'Non caricato'
        });
        greatObject.d1['files']['agenziademanio'] = undefined;
      break;
      case 'c':
        this.setState({
          c : 'Non caricato'
        });
        greatObject.d1['files']['pareretecnico'] = undefined;
      break;
      case 'd':
        this.setState({
          d : 'Non caricato'
        });
        greatObject.d1['files']['parereurbanistico'] = undefined;
      break;
      case 'e':
        this.setState({
          e : 'Non caricato'
        });
        greatObject.d1['files']['pareresopraintendenza'] = undefined;
      break;
      case 'f':
        this.setState({
          f : 'Non caricato'
        });
        greatObject.d1['files']['pareresic'] = undefined;
      break;
      case 'g':
        this.setState({
          g : 'Non caricato'
        });
        greatObject.d1['files']['parereautoritamarittima'] = undefined;
      break;
      case 'h':
        this.setState({
          h : 'Non caricato'
        });
        greatObject.d1['files']['pareresopraintendenzaarcheologica'] = undefined;
      break;
      case 'i':
        this.setState({
          i : 'Non caricato'
        });
        greatObject.d1['files']['parereautoritabacino'] = undefined;
      break;
    }
  }
...
//onClick={this._onFileInputChange.bind(this, 0,'Agenzia della dogana', 'a')}
