        ...
        <div style={{marginLeft:'20px'}}>
          ...
          <div style={{marginTop:'30px'}}>
            <RadioButtonGroup name="step5" defaultSelected={this.state.value} onChange={this._onRadioChange.bind(this)}>
              ...
              {this.state.value === 4 ?
                <Box column style={{marginRight : '20px'}}>
                  <AvvisoDiniegoFinale pid={this.props.pid} dbid={this.props.dbid} path={this.state.path}/>
                  <DiniegoDefinitivoFinale pid={this.props.pid} dbid={this.props.dbid} path={this.state.path}/>
                </Box>
                :
              null
              }
