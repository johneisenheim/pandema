...
class DiniegoDefinitivo extends React.Component{
  ...
  componentDidMount(){
    ...
    $.ajax({
        type: 'GET',
        //data: formData,
        url: 'http://127.0.0.1:8001/d1diniegodefinitivo?pid='+this.props.pid+'&dbid='+this.props.dbid,
        processData: false,
        contentType: false,
  ...
  downloadModulo(){
    window.open('http://127.0.0.1:8001/downloadAvvisoDiniegoDefinitivo', '_blank')
  }
      ...
      return (
          <Box column style={{marginTop:'30px', width:'90%'}} alignItems="flex-start" justifyContent="flex-start">
              <Toolbar style={{backgroundColor:'#4CA7D0', width:'100%'}}>
                <ToolbarTitle text="File caricato per Avviso Diniego Definitivo" style={{color:'#FFFFFF', textAlign:'center', fontSize:'15px'}}/>
...
export default DiniegoDefinitivo;
