              ...
              <Toolbar style={{backgroundColor:'#4CA7D0', width:'100%'}}>
                ...
                <ToolbarGroup style={{marginRight:'0px'}}>
                  <FlatButton label="Allega File" icon={<Attach style={{fill:'#FFFFFF'}}/>} style={{marginTop:'10px', marginRight:'0px'}} labelStyle={{color:'#FFFFFF'}}>
                     <input type="file" style={styles.inputFile} accept="application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" onChange={this._opposizioniFileHandler.bind(this)} ref="file"/>
                  </FlatButton>
                </ToolbarGroup>
              </Toolbar>
