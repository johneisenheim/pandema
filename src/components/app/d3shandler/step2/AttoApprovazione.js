...
class AttoApprovazione extends React.Component{
  ...
  componentDidMount(){
    ...
    $.ajax({
        type: 'GET',
        //data: formData,
        url: constants.DB_ADDR+'d3sapprovazione?pid='+this.props.pid+'&dbid='+this.props.dbid,
        processData: false,
        contentType: false,
      ...
      return (
          <Box column style={{marginTop:'30px', width:'90%'}} alignItems="flex-start" justifyContent="flex-start">
              <Toolbar style={{backgroundColor:'#4CA7D0', width:'100%'}}>
                <ToolbarTitle text="File caricato per Atto Approvazione" style={{color:'#FFFFFF', textAlign:'center', fontSize:'15px'}}/>
...
export default AttoApprovazione;
