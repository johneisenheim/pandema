...
class CertificatoMorte extends React.Component{
  ...
  componentDidMount(){
    ...
    $.ajax({
        type: 'GET',
        //data: formData,
        url: constants.DB_ADDR+'d4certificatomorte?pid='+this.props.pid+'&dbid='+this.props.dbid,
        processData: false,
        contentType: false,
...
export default CertificatoMorte;
