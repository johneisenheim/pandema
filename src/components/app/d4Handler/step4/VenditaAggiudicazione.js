...
class VenditaAggiudicazione extends React.Component{
  ...
  componentDidMount(){
    ...
    $.ajax({
        type: 'GET',
        //data: formData,
        url: constants.DB_ADDR+'d4venditaaggiudicazione?pid='+this.props.pid+'&dbid='+this.props.dbid,
        processData: false,
        contentType: false,
...
export default VenditaAggiudicazione;
