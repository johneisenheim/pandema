...
class Art55 extends React.Component{
  ...
  componentDidMount(){
    ...
    $.ajax({
        type: 'GET',
        //data: formData,
        url: constants.DB_ADDR+'getRegistriArt55?comune_id='+escape(global.city)+'&offset='+this.state.offset,
        processData: false,
        contentType: false,
  ...
  onSearchChange(e,v){
    ...
    if(v === ''){
      ...
      $.ajax({
          type: 'GET',
          url: constants.DB_ADDR+'searchTableH?search='+escape(v)+'&cid='+escape(global.city),
          processData: false,
          contentType: false,
          success: function(data) {
            var parsed = JSON.parse(data);
  ...
  reload(){
    ...
    $.ajax({
        type: 'GET',
        //data: formData,
        url: constants.DB_ADDR+'getRegistriGenerico?comune_id='+escape(global.city)+"&offset="+this.state.offset,
        processData: false,
        contentType: false,
        success: function(data) {
          var parsed = JSON.parse(data);
