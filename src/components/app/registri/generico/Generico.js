        ...
        for( var i = 0 ; i < this.state.data.length; i++ ){
          toReturn.push(
            <TableRow key={i}>
              ...
              <TableRowColumn>{this.state.data[i].localita}</TableRowColumn>
              <TableRowColumn>{this.state.data[i].superficie}</TableRowColumn>
              <TableRowColumn>{this.state.data[i].scopo}</TableRowColumn>
              <TableRowColumn>{new Date(this.state.data[i].data).toLocaleDateString()}</TableRowColumn>
              <TableRowColumn>{this.state.data[i].durata_mesi}</TableRowColumn>
              <TableRowColumn>{this.state.data[i].scadenza}</TableRowColumn>
              <TableRowColumn>{this.state.data[i].canone}</TableRowColumn>
              <TableRowColumn>{this.state.data[i].quietanza}</TableRowColumn>
                ...
                <Table selectable={false}>
                  <TableHeader adjustForCheckbox={false} displaySelectAll={false}>
                    <TableRow>
                      ...
                      <TableHeaderColumn>Località</TableHeaderColumn>
                      <TableHeaderColumn>Superficie</TableHeaderColumn>
                      <TableHeaderColumn>Scopo</TableHeaderColumn>
                      <TableHeaderColumn>Data</TableHeaderColumn>
                      <TableHeaderColumn>Durata(mesi)</TableHeaderColumn>
                      <TableHeaderColumn>Scadenza</TableHeaderColumn>
                      <TableHeaderColumn>Canone</TableHeaderColumn>
                      <TableHeaderColumn>Quietanza</TableHeaderColumn>
                      <TableHeaderColumn>Pertinenza</TableHeaderColumn>
